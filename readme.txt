...
Where you want to process a shortcode with priority, use "[[" at the start and "]]" at the end. For example: `[my-shortcode]` becomes `[[my-shortcode]]` and `[my-shortcode]Some content.[/my-shortcode]` becomes `[[my-shortcode]Some content.[/my-shortcode]]`.
